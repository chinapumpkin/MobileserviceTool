...
public class UVCCamera {
    ...
    //setting for the Camera argument
//480p
    public static final int DEFAULT_PREVIEW_WIDTH = 176;//640
    public static final int DEFAULT_PREVIEW_HEIGHT = 144;//480
