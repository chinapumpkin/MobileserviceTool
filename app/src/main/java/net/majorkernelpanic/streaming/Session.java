...
public class Session {
    ...
    private UVCAudioStream mAudioStream = null;
    private UVCVideoStream mVideoStream = null;
     ...
     */
    void addAudioTrack(UVCAudioStream track) {
        removeAudioTrack();
        mAudioStream = track;
    }
     ...
     * You probably don't need to use that directly, use the {@link SessionBuilder}.
     */
    void addVideoTrack(UVCVideoStream track) {
        removeVideoTrack();
        mVideoStream = track;
    }
    ...
    /**
     * Returns the underlying {@link UVCAudioStream} used by the {@link Session}.
     */
    public UVCAudioStream getAudioTrack() {
        return mAudioStream;
    }

    /**
     * Returns the underlying {@link UVCVideoStream} used by the {@link Session}.
     */
    public UVCVideoStream getVideoTrack() {
        return mVideoStream;
    }
     ...
     * It can be either {@link Camera.CameraInfo#CAMERA_FACING_BACK} or
     ...
     * //{@link Session#getVideoTrack()} and {@link UVCVideoStream# getFlashState()}.
     **/
    ...
    public interface Callback {
        ...
        /**
         * Called when the previw of the {@link UVCVideoStream}
